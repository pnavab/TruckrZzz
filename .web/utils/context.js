...
export const initialState = {"state": {"is_hydrated": false, "router": {"session": {"client_token": "", "client_ip": "", "session_id": ""}, "headers": {"host": "", "origin": "", "upgrade": "", "connection": "", "pragma": "", "cache_control": "", "user_agent": "", "sec_websocket_version": "", "sec_websocket_key": "", "sec_websocket_extensions": "", "accept_encoding": "", "accept_language": ""}, "page": {"host": "", "path": "", "raw_path": "", "full_path": "", "full_raw_path": "", "params": {}}}}, "state.state": {}, "state.dashboard_state": {"filtered_truckers_data": [], "search_query": "", "truckers_data": []}, "state.navbar_state": {}, "state.webcam_state": {"drowsy": false, "processed_frame": ""}, "state.popover_state": {"device_id": "", "name": ""}, "state.graph_state": {"data": [{"name": "Start", "awake": 9, "sleepy": null}, {"name": "Start", "awake": 6, "sleepy": 6}, {"name": "Start", "awake": 5, "sleepy": null}], "graph_data": [{"name": "start", "value": 9}], "last_value": 9, "running": false, "sleepiness_value": 4}, "state.flashing_state": {"color": "white", "flash": 0}}
...
=======
  ...
  state__flashing_state: createContext(null),
}
...
export function StateProvider({ children }) {
  ...
  const [state__flashing_state, dispatch_state__flashing_state] = useReducer(applyDelta, initialState["state.flashing_state"])
...
=======
  ...
  const dispatchers = useMemo(() => {
    return {
      ...
      "state.flashing_state": dispatch_state__flashing_state,
    }
  }, [])
  ...
  return (
    ...
    <StateContexts.state__flashing_state.Provider value={ state__flashing_state }>
      <DispatchContext.Provider value={dispatchers}>
        {children}
      </DispatchContext.Provider>
    </StateContexts.state__flashing_state.Provider>
