            ...
            rx.scroll_area(
                rx.hstack(
                    rx.box(
                        ...
                        rx.heading("Webcam Integration",
                                   text_align="center", size="5", padding="5px"),
                        rx.fragment(
                            rx.box(
                    ...
                    rx.box(
                        ...
                        rx.spacer(),
                        rx.heading("Livestream Heartrate",
                                   text_align="center", size="5", padding="5px"),
                        rx.fragment(
                            rx.box(
